      ...
      <div className="relative h-full grid md:grid-cols-12 gap-4 md:gap-6 p-5 md:p-10 lg:p-12">
        ...
        <div className="md:col-span-7 flex flex-col justify-between min-h-0">
          ...
          <div className="max-w-lg">
            <h3 className="font-display font-semibold text-warm-cream text-xl md:text-3xl lg:text-4xl leading-[1.1] tracking-tight mb-2 md:mb-3">
              {slide.title}
            </h3>
          </div>
        </div>
        ...
        <div className="md:col-span-5 flex flex-col justify-start md:pt-12">
          <div className="rounded-2xl bg-warm-cream/[0.08] backdrop-blur-md border border-warm-cream/15 p-4 md:p-5 space-y-2 md:space-y-2.5">
            <p className="text-warm-cream/60 text-[9px] md:text-[10px] font-bold uppercase tracking-[0.2em] mb-3">
            ...
            {slide.features.map((f, i) => (
              ...
              >
                ...
                >
                  <f.icon className="w-3.5 h-3.5 md:w-4 md:h-4 text-warm-cream" />
                </div>
                <p className="text-warm-cream/90 text-[11px] md:text-sm leading-snug font-medium pt-1 md:pt-1.5">
                  {f.label}
                </p>
              </motion.div>
            ))}
